...
<div id="app">
    ...
    <div class="paginacion">
        <button id="anterior" class="boton">&laquo; Anterior</button> <!-- &laquo; añade simbolo de 2 flechitas izq -->
        <button id="siguiente" class="boton"> Siguiente &raquo;</button> <!-- &raquo; añade simbolo de 2 flechitas der-->
    </div>
</div>
